...
<section class="content">
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        <select class="form-control select2" name="category_id">
                            ...
                            <?php //foreach ($this->album->categories() as $key => $value) { 
                            ?><option <?php//=($value['id']===$this->album->categoryId()) ? 'selected="selected" ' : '';?>value="<?=$value['id'];?>"><?=$value['title'];?></option>
                            <?php //}   ?>-->
    ...
    ?><p>Ostatnia modyfikacja: <b><?=$this->album->modified();
    ?></b></p>
                        <p>Ostatnio edytował: <b><?=$this->album->modifierFullName();
    ?></b></p><?php 
} ?>
