  ...
  <div class="row">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="more">
            ...
            <div class="form-group">
              ...
              <p class="text-muted">Adres pod jakim będzie dostępny album (http://twojastrona.pl/artykuly/<?=$a->date('Y');?>/<?=$a->date('m');?>/<b>{URL)</b>. Jeśli zostawisz to pole puste, URL zostanie wygenerowany automatycznie.</p>
            </div>
    ...
    <div class="col-md-4">
      <div class="box box-default">
        ...
        <div class="box-body">
          <p><i class="fa fa-key"></i> Status: <b><?=($a->isPublished()) ? 'opublikowany' : 'szkic';?></b></p>
