...
<head>
	...
	<!-- iCheck -->
	<link rel="stylesheet" href="<?=$this->themePath;?>/bower_components/AdminLTE/plugins/iCheck/square/blue.css">
...
<!-- iCheck -->
<script src="<?=$this->themePath;?>/bower_components/AdminLTE/plugins/iCheck/icheck.min.js"></script>
<script>
	$(function () {
		$('input').iCheck({
