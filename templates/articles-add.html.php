...
<section class="content">
	<div class='row'>
		...
		<!-- form -->
		<form method="post" action="<?=$this->request;?>">
			<div class='col-md-8'>
				<div class="nav-tabs-custom">
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="more">
							...
							<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-md-6" id="thumbnail-preview">
										<?php $this->thumbnail(300, 250, false, true);?>
							...
							<div class="form-group">
								<label>Album</label>
								<input type="text" name="album" value="<?php //$this->album();?>" placeholder="Album" class="form-control"/>
								<p class="text-muted">Adres albumu powiązanego z artykułem. Pole puste = brak powiązania.</p>
							</div>

							<div class="form-group">
								<label>Liczba zdjęć</label>
								<input type="number" name="photos" value="<?=$this->photos();?>" placeholder="Liczba zdjęć" class="form-control"/>
			...
			<div class="col-md-4">
				...
				<div class="box box-default">
					...
					<div class="box-body">
						<p><i class="fa fa-key"></i> Status: <b><?php //($this->isPublished()) ? 'opublikowany' : 'szkic';?></b></p>
						<!--<p><i class="fa fa-eye"></i> Widoczność: <b>wszędzie</b></p>-->
						<!--<p><i class="fa fa-calendar"></i> Data wyświetlana: <b><?php //$this->datetime();?></b></p>-->

						<!-- checkbox -->
						<hr/>
						<label>
						<input type="checkbox" name="published" class="minimal"<?php //($this->isPublished()) ? ' checked' : '';?>/>&nbsp;
				...
				<div class="box box-default">
					...
					<div class="box-body">
						<select class="form-control select2" name="category_id">
							...
							?><option <?($value['id']===$this->categoryId()) ? 'selected="selected" ' : '';?>value="<?=$value['id'];?>"><?=$value['title'];?></option>
							<?php //}	?>
						
						</select>
						<hr/>
						<a href="<?php //=$this->addCategory();?>" target="_blank">Dodaj kategorię</a>
